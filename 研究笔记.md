...
| L1 | 64 | 6,144 | 272 / 6 | 1M | Sliding + Full |
| G1 | 51 | 12,288 | 128 / 4 | 1M | Sliding + Full |
| G2 | 48 | 12,288 | 128 / 4 | 1M | Sliding + Full |
| D1 | 56 | 8,192 | 256 / 6 | 1M | Sliding + Full |
| D2 | 88 | 5,120 | 192 / 5 | 1M | Sliding + Full |
| K1 | 84 | 4,608 | 480 / 16 | 1M | Sliding + Full |
| K2 | 52 | 6,656 | 416 / 14 | 1M | Sliding + Full |
...
## 五、1M 上下文能力与 400K 工作负载轴

所有 L/G/D/K 缩放候选统一把 **1,048,576 token（表中简写为 1M）**作为上下文能力设计目标；NVIDIA Figure 11 使用的仍是 cached/total input length 400K、新增上下文 4K、输出 400 的评测点。上下文长度不进入权重参数账本，因此改为 1M 不会改变总参数或激活参数；但 1M 能力不会由 2T 规模自动产生，仍要求相应的位置编码训练、attention FLOPs、KV/压缩状态、CP/SP 策略和推理 kernel 支持。

因此，候选表中的 `1M` 表示**目标能力上限**，Figure 11 的 `400K` 表示**具体工作负载**。在该工作负载下，仅讨论 2T 权重是不够的。
...
| 缩放候选 | L1 / DSV4 Top-6 / 64层硬件基线 | 1.981T | 52.08B | 2.629% | 64 | 6,144 | 272 / 6 | 1M | Sliding + Full | 固定 64 层、6144 宽、top-6 |
| 缩放候选 | G1 / GPT-OSS 比例 / 原生 Top-4 | 2.000T | 87.26B | 4.364% | 51 | 12,288 | 128 / 4 | 1M | Sliding + Full | 保持 GPT 激活比例与 top-4，主扩宽 |
| 缩放候选 | G2 / GPT-OSS 比例 / 并行拓扑优先 | 1.998T | 85.90B | 4.299% | 48 | 12,288 | 128 / 4 | 1M | Sliding + Full | TP32 + EP64 + PP16 严格整除 |
| 缩放候选 | D1 / DeepSeek 比例 / Top-6 | 2.000T | 60.96B | 3.047% | 56 | 8,192 | 256 / 6 | 1M | Sliding + Full | 固定 top-6，拟合 2T / 61.29B |
| 缩放候选 | D2 / DeepSeek 比例 / 自由 Top-N | 2.004T | 61.33B | 3.061% | 88 | 5,120 | 192 / 5 | 1M | Sliding + Full | 自由 top-N，拟合 2T / 61.29B |
| 缩放候选 | K1 / Kimi 比例 / Top-16 | 2.007T | 74.84B | 3.729% | 84 | 4,608 | 480 / 16 | 1M | Sliding + Full | 固定 top-16，拟合 2T / 74.82B |
| 缩放候选 | K2 / Kimi 比例 / 自由 Top-N | 2.000T | 74.85B | 3.743% | 52 | 6,656 | 416 / 14 | 1M | Sliding + Full | 自由 top-N，拟合 2T / 74.82B |
